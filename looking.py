...
class Dragged:
    ...
    def dnd_end(self, Target, Event):
        ...
        if self.Canvas == None and self.OriginalCanvas == None:
            ...
            return
        if self.Canvas == None and self.OriginalCanvas is not None:
    ...
    def Appear(self, Canvas, XY):
        ...
        self.Label = Label(Canvas, text=self.Name,
    ...
    def Press(self, Event):
        ...
        if dnd.dnd_start(self, Event):
            ...
            self.OffsetX, self.OffsetY = MouseInWidget(
                self.OriginalLabel, Event)
